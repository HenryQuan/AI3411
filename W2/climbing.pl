...
% climb(Name, _, person('Barry', 'Drake'), _).

% Write and execute a query to find the climbs first climbed by a female.
% climb(Name, _, P, _), female(P).

% 1 is later than 2 (must not omit Month and Year)
